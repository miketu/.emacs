...
This is the MTU filing system. This ./0 index/ folder functions as a global index to all my files in the event of backup. It consists of a few key elements.

- Root of A Cloud Service Folder
